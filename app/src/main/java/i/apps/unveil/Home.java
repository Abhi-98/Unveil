...
public class Home extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {
    ...
    Button comedy,romance,action,crime,thriller,ok;
...
//
        ...
        acTextView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                Intent intent = new Intent(Home.this, Episode.class);
    ...
    private void showCustomDialog() {
        ...
        comedy = dialogView.findViewById(R.id.comedy);
        romance = dialogView.findViewById(R.id.romance);
        action = dialogView.findViewById(R.id.action);
        crime = dialogView.findViewById(R.id.crime);
        thriller = dialogView.findViewById(R.id.thriller);
        ...
        comedy.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(Home.this, genreOFilter.class);
                intent.putExtra("genre", "Comedy"); // getText() SHOULD NOT be static!!!
                startActivity(intent);
            }
        });
        ...
        romance.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(Home.this, genreOFilter.class);
                intent.putExtra("genre", "Romance"); // getText() SHOULD NOT be static!!!
                startActivity(intent);
            }
        });
        action.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(Home.this, genreOFilter.class);
                intent.putExtra("genre", "Action"); // getText() SHOULD NOT be static!!!
                startActivity(intent);
            }
        });
        crime.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(Home.this, genreOFilter.class);
                intent.putExtra("genre", "Crime"); // getText() SHOULD NOT be static!!!
                startActivity(intent);
            }
        });
        thriller.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(Home.this, genreOFilter.class);
                intent.putExtra("genre", "Thriller"); // getText() SHOULD NOT be static!!!
                startActivity(intent);
            }
        });
        star5.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(Home.this, genreFilter.class);
